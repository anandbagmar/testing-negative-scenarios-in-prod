...
public class TimedOutScreenAndroid extends TimedOutScreen {
    private final Driver driver;
    private final Visual visually;
    private final WebDriver innerDriver;
    private final TestExecutionContext context;
    private static final String SCREEN_NAME = TimedOutScreenAndroid.class.getSimpleName();
    ...
    public TimedOutScreenAndroid(Driver driver, Visual visually) {
        this.driver = driver;
    ...
    private WebElement waitForTimeoutScreen() {
        driver.waitTillElementIsVisible(BY_BACK_BUTTON_XPATH, 30);
