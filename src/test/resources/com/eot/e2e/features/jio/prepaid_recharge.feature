...
##  CONFIG=./teswiz_configs/configs/jio_local_android_config.properties TAG="@1Plans" ./gradlew run
#  @android @web @1Plan
...
##  CONFIG=./teswiz_configs/configs/jio_local_android_config.properties TAG="@2Plans" ./gradlew run
#  @android @web @2Plans
...
##  CONFIG=./teswiz_configs/configs/jio_local_android_config.properties TAG="@5Plans" ./gradlew run
#  @android @web @5Plans
...
##  CONFIG=./teswiz_configs/configs/jio_local_android_config.properties TAG="@10Plans" ./gradlew run
#  @android @web @10Plans
