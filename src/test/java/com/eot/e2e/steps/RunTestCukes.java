...
public class RunTestCukes
    ...
    public static void afterAll() {
        LOGGER.info("RunTestCukes: afterAll");
        SpecmaticStudioManager.stopIfRunning();
    }
    ...
    public void beforeTestScenario(Scenario scenario) {
        ...
        isEnvironmentHealthy(context.getTestName(), Runner.getFromEnvironmentConfiguration(E2E_TEST_CONTEXT.HEALTH_CHECK_URL));
    }
    ...
    private void closeHeartBeatThreads() {
        //        if (null != context.getTestState(E2E_TEST_CONTEXT.HEARTBEAT_MAP)) {
